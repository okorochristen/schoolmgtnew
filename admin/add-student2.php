  ...
  if ($_FILE['passport']['error'] > 0) {
    $_SESSION['passport'] = 1;
      ...
      elseif ( ($_FILES['passport']['type'] != 'image/png') && ($_FILES['passport']['type'] != 'image/jpg') && ($_FILES['passport']['type'] != 'image/jpeg') ) {
        ...
        $loc = "../studs/primary applicants/".$passport;

        if (move_uploaded_file($image, $loc)) {
            $query="INSERT INTO primary_applicants(regno, fname, start_session, gender, dob, religion, state, lga, nationality, class_app,
            address, parent, parent_num, passport, status) VALUES (:regno, :fname, :session, :gender, :dob, :religion, :state, :lga,
...
<html>
<head>
<title>Admin Add Primary Students</title>
          ...
          <div class="tab-pane active" id="horizontal-form">
            <form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="date" name="dob" class="form-control1" placeholder="Date of Birth">
                </div>
              </div>
              <div class="form-group">
                <label for="focusedinput" class="col-sm-2 control-label">State of Origin</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control1" name="state" placeholder="State of Origin">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <select class="form-control1" name="class_app" onchange="master()" required id="sl">
