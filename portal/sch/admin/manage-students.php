...
<html>
<head>
<title>Admin Manage Secondary Students</title>
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Secondary Students</li>
            </ol>
					  ...
					  <h2>
					    ...
					    <table id="table">
					        <div class="btn-group  pull-right">
                                 <a href="manage-students.php?cl=1" class="btn btn-default <?php if($cl == 1){echo 'active';} ?>">JSS1</a>
                                 <a href="manage-students.php?cl=2" class="btn btn-default <?php if($cl == 2){echo 'active';} ?>">JSS2</a>
                                 <a href="manage-students.php?cl=3" class="btn btn-default <?php if($cl == 3){echo 'active';} ?>">JSS3</a>
                                 <a href="manage-students.php?cl=4" class="btn btn-default <?php if($cl == 4){echo 'active';} ?>">SSS1</a>
                                 <a href="manage-students.php?cl=5" class="btn btn-default <?php if($cl == 5){echo 'active';} ?>">SSS2</a>
                                 <a href="manage-students.php?cl=6" class="btn btn-default <?php if($cl == 6){echo 'active';} ?>">SSS3</a>
                            </div>
						<thead>
						  <tr>
						  <th>Passport</th>
