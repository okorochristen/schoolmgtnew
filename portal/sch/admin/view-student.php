				...
				<div class="agile-tables col-md-8">
					...
					<div class="w3l-table-info">
						...
						<h2>STUDENT INFORMATION</h2>
							<table>
									<a href="manage-students2.php" class="btn btn-warning" style="margin-right:25px">Back</a><a href="remove-student.php?id=<?php echo $id; ?>&school=secondary" class="btn btn-warning" style="background-color:red; color:white;">Remove</a>
						<tbody>
							<tr>
								<td>NAME:</td>
								<td><?php echo $name;?></td>
