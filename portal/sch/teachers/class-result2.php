...
<?php if ( (isset($_SESSION['login'])) && (strlen($_SESSION['login']) >  0) ): ?>
    <?php if ( (isset($_REQUEST['class'])) && (isset($_REQUEST['session'])) && (isset($_REQUEST['term'])) && (isset($_REQUEST['class2'])) ):
      ...
      $term = $_REQUEST['term'];
      $q = $db->prepare('select regno, average, position from result2 where class = ? and sclass = ? and session = ? and term = ?');
          ...
          <div class="col-md-12">
                ...
                <tbody>
                 ...
                 ?>
                  <tr>
                    ...
                    <td><a href="myresult2.php?regno=<?php echo $regno; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&class=<?php echo $class; ?>&class2=<?php echo $sclass; ?>" target="_blank">View</a></td>
                  </tr>
                <?php endwhile; ?>
              </tbody>
            ...
            ?>
              ...
              <div class="sspacing">
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <!--<a href="compute-result2.php?term=<?php echo $term; ?>&session=<?php echo $session; ?>&class=<?php echo $class; ?>&class2=<?php echo $sclass; ?>" class="btn btn-sm btn-success">Compute</a>-->
                    <a href="select-primary-class2.php" class="btn btn-outline-success">Back</a>
                  </div>
                </div>
              </div>
