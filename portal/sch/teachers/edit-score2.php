...
<?php if (isset($_SESSION['login'])): ?>
  <?php if ( (isset($_GET['regno'])) && (isset($_GET['term'])) && (isset($_GET['subject'])) && (isset($_GET['session'])) && (isset($_GET['class'])) && (isset($_GET['class2'])) ) :
    ...
    $q = $db->prepare('select as1, as2, ts1, ts2, exam, total from scores2 where session = ? and term = ? and class = ? and subject = ? and regno = ? and class2 = ?');
  ...
  <html>
    <head>
      ...
      <body class="bglight">
        <section class="bglight  borderbottom mt-30" style="margin-top: 40px">
          <div class="col-8 offset-3">
            <div class="row">
                <div class="card">
                    <div class="card-heading text-white bg-primary">
                        <div class="col-sm-12 form-group">
                              <h3 for="reg_number" class="size20 cblue text-center">Edit <?php echo $name; ?> Score in <?php echo $subject; ?></h3>
                          </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="cover-center-text col-sm-12 col-md-12">
                  ...
                  <script type="text/javascript" src="assets/js/calc.js"></script>
                    <form method="post" action="edit-script2.php">
                      ...
                      <div class="container">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-sm-10">
                              ...
                              <a href="enter-scores2.php?subject=<?php echo $subjectid; ?>&class=<?php echo $class; ?>&class2=<?php echo $class2; ?>&term=<?php echo $term; ?>" class="btn btn-outline-primary input-sm">Back</a>
                          </div>
                          <div >
  ...
  <?php else:
    header("Location:enter-scores2.php?subject=$subjectid&class=$class&class2=$class2&term=$term");
    exit;
  ?>
  <?php endif; ?>
<?php else:
