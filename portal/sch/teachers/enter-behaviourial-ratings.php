...
<html>
  <head>
      ...
      <title>Secondary Students Behaviourial Ratings</title>
...
<div class="container-fluid" style="margin-top: 60px">
  <div class="col-md-12">
    ...
    <?php if ($q0->num_rows > 0): ?>
      <h3 class="card-title" style="text-transform: uppercase;"> Enter <?php echo $cl." ".$class2; ?> students behaviourial ratings.</h3><br><br>
    ...
    <div class="card-body">
        <table class="table table-bordered table-condensed">
          ...
          <tbody>
            <form class="" action="sbehaviourial-script.php" method="post">
            <?php while ($q0->fetch()): ?>
              <?php
                $q = $db->prepare('select punctuality, attendance, assignment, school_act, neatness, honesty, self_control, relationship, games, lab from secondary_behaviour where session = ? and term = ? and class = ? and class2 = ? and regno = ?');
            ...
            <tr>
              ...
              <td colspan="12">
                <div class="col-md-6 pull-right">
                    <button type="submit" class="btn btn-outline-success pull-right" id="btn" name="bhv_btn2">Submit</button>
                </div>
                <div class="col-md-6 pull-left">
                      <a href="select-class3.php" class="btn btn-outline-info">Go Back</a>
                  </div>
              </td>
            </tr>
