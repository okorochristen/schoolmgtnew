...
<?php if ( (isset($_SESSION['login'])) && (!(empty($_SESSION['login']))) ): ?>
  <?php if ( (isset($_GET['regno'])) && (isset($_GET['session'])) && (isset($_GET['term'])) && (isset($_GET['class'])) && (isset($_GET['class2']))):
    ...
    $q = $db->prepare('select position, total, average, class_average from result where regno = ? and session = ? and term = ? and class = ? and sclass = ?');
                ...
                <div class="cover-center-text col-sm-12 col-md-12">
                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                          $q0 = $db->prepare('select subject, as1, as2, ts1, ts2, exam, total, grade, class_average, staffid from scores where regno = ? and session = ? and term = ? and class = ? and class2 = ?');
