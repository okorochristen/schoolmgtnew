...
<?php if ( (isset($_SESSION['login'])) && (strlen($_SESSION['login']) >  0) ):
  ...
  $q = $db->prepare("select distinct class from promotional_result1");
  $q->execute();
  $q->store_result();
...
<div class="container" style="padding-top: 120px">
  ...
  <div class="col-md-12">
    ...
    <form role="form" action="result-summary1.php" method="GET" class="col-sm-offset-3">
      ...
      <div class="form-group col-sm-8">
        <select class="form-control input-sm" name="session" required>
          ...
          <?php
            $q1 = $db->prepare("select distinct session from promotional_result1 order by session desc");
            $q1->execute();
