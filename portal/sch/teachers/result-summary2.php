...
<?php if ( (isset($_SESSION['login'])) && (strlen($_SESSION['login']) >  0) ): ?>
  ...
  <?php if ( (isset($_REQUEST['class'])) && (isset($_REQUEST['session'])) ):
    ...
    $q = $db->prepare('select distinct regno, average, position, status from promotional_result2 where class = ? and session = ?');
  ...
  <html>
    <head>
        ...
        <script type="text/javascript" src="includes/prompt2.js"></script>
    ...
    <body class="bglight bgwhite">
      <div class="container" style="margin-top: 50px">
        <h3 class="text-center">Result summary of <?php echo $cl; ?></h3>
        <div class="col-md-12">
              ...
              <tbody>
               ...
               ?>
                <tr>
                  ...
                  <td><a href="student-result-summary2.php?regno=<?php echo $regno; ?>&session=<?php echo $session; ?>&class=<?php echo $class; ?>" target="_blank">View</a></td>
                  <td colspan="2">
