...
<?php if ( (isset($_SESSION['login'])) && (strlen($_SESSION['login']) >  0) ): ?>
  <?php if ( (isset($_GET['regno'])) && (isset($_GET['session'])) && (isset($_GET['class'])) && (isset($_GET['class2']))):
    $regno = $_GET['regno'];
    $class = $_GET['class'];
    ...
    $q = $db->prepare('select position, total, average, class_average from promotional_result1 where regno = ? and session = ? and class = ? and class2 = ?');
            ...
            <div class="row">
              <div class="container cus-pos-abs">
                <div class="cover-center-text col-sm-12 col-md-12">
                  ...
                  <p><b>Class: </b> <?php echo $cl." ".$class2; ?></p><br>
                  ...
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        ...
                        <?php
                          $q0 = $db->prepare('select subject, total, grade, class_average from promotional_scores1 where regno = ? and session = ? and class = ? and class2 = ?');
