...
$sql="INSERT INTO teachers(name,gender,phone,email,address,password) VALUES(:name,:gender,:phone,:email,:address,:password)";
...
<html>
<head>
<title>SMS | Admin Add Teacher</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Teacher Details </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control1" name="email" placeholder=" Email Address" required>
									</div>
								</div>
