...
<div class="col-8 offset-2" style="margin-top:20px; margin-bottom:20px">
	...
	<div class="row">
        <div class="form-group col-md-4">
        	...
        	<input type="text" placeholder="Full Name" name="fname" class="form-control input-lg" required="required">
        </div>
        <div class="form-group col-md-4">
        	<label>Gender</label>
    ...
    <div class="row">
    	...
    	<label>Religion</label>
    		...
    		<select class="form-control input-lg" name="religion" required>
...
<div class="form-group mt17 col-sm-4">
	...
	<select class="form-control input-lg" name="class_app">
...
<div class="form-group col-12" style="margin-bottom: 10px">
	<label style="font-weight:bold">Upload Passport</label>
 <input type="file" class="btn btn-outline-success col-3" name="passport" required>
 <button class="btn btn-outline-success btn-lg input-lg col-3" type="submit" name="submit">APPLY</button>
</div>
</div>
<div class="form-group mt17 col-12">
