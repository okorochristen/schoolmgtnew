  ...
  <div class="col-12">
    ...
    <div class="card-heading text-white bg-primary">
        ...
        <table class="table table-hover table-responsive table-striped" style="margin-bottom:70px">
          ...
          <tbody>
            <form class="" action="scores-script2.php" method="post">
            <?php while ($q0->fetch()): ?>
              <?php
                $q = $db->prepare('select as1, as2, ts1, ts2, exam, total from scores2 where session = ? and term = ? and class = ? and subject = ? and regno = ?');
              ...
              <tr>
                ...
                ?>
                  ...
                  <td><a href="edit-score2.php?class2=<?php echo $class2; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&class=<?php echo $class; ?>&subject=<?php echo $subject; ?>&regno=<?php echo $regno; ?>" class="btn btn-outline-info">Edit</a></td>
                  <td><a href="delete-score2.php?class2=<?php echo $class2; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&class=<?php echo $class; ?>&subject=<?php echo $subject; ?>&regno=<?php echo $regno; ?>" class="btn btn-outline-danger">Delete</a></td>
                <?php else: ?>
                  ...
                  <input type="hidden" name="session" value="<?php echo $sn; ?>">
            ...
            <tr>
              <td colspan="10">
                  <div class="col-md-6 pull-left">
                      <a href="select-primary-class.php" class="btn btn-outline-primary">Go Back</a>
                  </div>
...
<?php else:
  $_SESSION['rac'] = 1;
  header("Location:class-result2.php?session=$sn&class=$class&term=$term");
  exit;
?>
<?php endif; ?>
<?php else:
  header('Location:select-primary-class.php?');
  exit;
?>
<?php endif; ?>
<?php else:
